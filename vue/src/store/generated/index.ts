...
import KlpandaPlanetKlpandaPlanetPlanet from './klpanda/planet/klpanda.planet.planet'
...
export default { 
  ...
  KlpandaPlanetKlpandaPlanetPlanet: load(KlpandaPlanetKlpandaPlanetPlanet, 'klpanda.planet.planet'),
